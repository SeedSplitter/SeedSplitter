...
SeedSplitter es un dispositivo de hardware que divide tu seed phrase de Bitcoin en 3 partes independientes, cada una una wallet BIP39 válida y funcional.
...
- El dispositivo genera 3 seed phrases válidas e independientes
...
- Sin WiFi ni Bluetooth — imposible filtrar datos
- Sin memoria persistente — al apagar, no queda ningún rastro
